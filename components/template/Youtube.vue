        ...
        <div class="template-youtube">
                ...
                <div class="template-youtube-screen-blur">
                    <div class="template-youtube-screen-play">
                        <svg xmlns="http://www.w3.org/2000/svg" width="180" height="180" viewBox="0 0 180 180"
                            ...
                            <defs>
                                <filter id="filter0_d_918_49700" x="0" y="0" width="180" height="180"
                                    ...
                                    <feBlend mode="normal" in2="BackgroundImageFix"
                                        result="effect1_dropShadow_918_49700" />
                                    <feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_918_49700"
                                        result="shape" />
                                </filter>
                            </defs>
                        </svg>
            ...
            <Dialog v-model:visible="youtubeVideoVisible" header="Video Content" :style="{ width: '70vw' }">
                <div class="template-youtube-video">
                    <iframe :src="youtubeLink" title="PrimeNG 2023 Roadmap" frameBorder="0"
