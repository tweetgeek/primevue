<template>
                ...
                <Column field="company" header="Company Name">
                    <template #body="{ data }">
                        <div class="flex items-center gap-2">
                            <div class="flex items-center justify-center" v-html="companyLogos[data.company.logo]">
                            </div>
    ...
    <Drawer v-model:visible="visibleRight" :containerVisible="true" header="Right Sidebar" position="right"
...
export default {
    ...
    data() {
        return {
            ...
            chartOptions: {},
            tableData: [
                { id: 1, image: '/demo/images/avatar2.png', active: true, name: 'Brook Simmons', title: 'Sales Executive ', company: { name: 'Mistranet', logo: 'mistranet' }, email: 'hi@brooksmmns.co', lead: 'Linkedin', status: 'Active' },
                { id: 2, image: '/demo/images/avatar9.jpg', active: true, name: 'Dianne Russell', title: 'CEO', company: { name: 'BriteMank', logo: 'britemank' }, email: 'hi@diannerussell.com', lead: 'Website', status: 'Inactive' },
                { id: 3, image: '/demo/images/avatar13.jpg', active: undefined, name: 'Amy Elsner', title: 'Product Manager', company: { name: 'ZenTrailMs', logo: 'zentrailms' }, email: 'hi@amyelsner.com', lead: 'Cold Call', status: 'Prospect' },
                { id: 4, image: '/demo/images/avatar11.jpg', active: true, name: 'Jacob Jones', title: 'Manager', company: { name: 'Streamlinz', logo: 'streamlinz' }, email: 'jacobjones@gmail.com', lead: 'Partner', status: 'Prospect' },
                ...
                { id: 7, image: '/demo/images/avatar7.png', active: true, name: 'Guy Hawkins', title: 'Director', company: { name: 'Wavelength', logo: 'wavelength' }, email: 'hi@darrellsteward.com', lead: 'Linkedin', status: 'Active' },
                { id: 8, image: '/demo/images/avatar8.png', active: true, name: 'Annette Black', title: 'Manager', company: { name: 'Wavelength', logo: 'wavelength' }, email: 'jeromebell@gmail.com', lead: 'Website', status: 'Inactive' },
                { id: 9, image: '/demo/images/avatar10.jpg', active: undefined, name: 'Darrell Steward', title: 'Product Manager', company: { name: 'ZenTrailMs', logo: 'zentrailms' }, email: 'hi@onyamalimba.co', lead: 'Website', status: 'Active' },
                ...
                { id: 11, image: '/demo/images/avatar12.jpg', active: undefined, name: 'Onyama Limba', title: 'Sales Executive ', company: { name: 'BriteMank', logo: 'britemank' }, email: 'hi@arlenemccoy.com', lead: 'Social Media', status: 'Active' },
            ],
            companyLogos: {
                'mistranet': `
