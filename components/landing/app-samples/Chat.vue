<template>
    <div class="flex-1 h-full overflow-y-auto overflow-x-clip overflow-hidden flex border border-surface rounded-2xl">
                ...
                <div class="flex items-center">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="text-muted-color leading-5 line-clamp-1 mt-1">Cody Fisher, Esther Howard, Jerome
                            Bell,
                            Kristin Watson, Ronald Richards, Darrell Steward</div>
                    </div>
                </div>
        ...
        <div class="flex-[0.25] min-w-40 py-6 px-3 overflow-auto">
...
export default {
    ...
    data() {
        return {
            ...
            chatMedia: [
                '/demo/images/chat-image1.png',
                '/demo/images/chat-image2.png',
                '/demo/images/chat-image3.png',
                '/demo/images/chat-image4.png',
                '/demo/images/chat-image5.png',
            ],
            members: [
