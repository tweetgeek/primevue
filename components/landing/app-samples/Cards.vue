        ...
        <div class="mt-6 flex flex-wrap items-start gap-6">
            <div class="flex-1 flex flex-col gap-6">
                <div class="border border-surface rounded-3xl p-6 flex flex-col gap-6">
                    ...
                    <div class="flex items-center gap-6">
                        <div class="text-sm leading-5 text-color">14.k <span class="text-muted-color">Followers</span>
                        </div>
                        <div class="text-sm leading-5 text-color">359 <span class="text-muted-color">Following</span>
                        </div>
                    </div>
                    <p class="text-sm text-muted-color leading-5 mb-0">Meet Jacob Jones, the whimsical adventurer on a
                        quest for life's quirks. From sock mysteries to subway adventures, join him for a
                        laughter-filled journey!</p>
                    ...
                    <SelectButton v-model="selectedUserSelectButtonOption" :options="userSelectButtonOptions" :pt="{
                        root: {
                            class: 'w-full'
                        },
                        pcbutton: {
                ...
                <div class="border border-surface rounded-3xl p-6">
                    <div
                        ...
                        <Avatar image="/demo/images/main-avatar.png" class="rounded-lg overflow-hidden w-14 h-14" />
                        <div class="flex-1">
                    ...
                    <div
                        ...
                        <i class="pi text-lg w-7 h-7 flex items-center justify-center" :class="{
                            'pi-moon': !darkMode,
                            'pi-sun': darkMode
                        }"></i>
                        <div class="font-medium leading-normal flex-1 text-left">Switch to {{ darkMode ? 'Light' :
                            'Dark' }}</div>
                ...
                <div class="border border-surface rounded-3xl">
                    <div class="pt-6 px-6 flex flex-col gap-6">
                        ...
                        <p class="leading-6 text-muted-color mb-0">Expert in data analysis? Join Data Insights Ltd. as a
                            senior data analyst. Lead in the world of data with us!</p>
                                    ...
                                    <div class="flex flex-wrap gap-2 grow overflow-auto max-h-[210px]">
                                        <div v-for="(file, index) of files" :key="file.name + file.type + file.size"
                                            ...
                                            <div class="grow flex flex-col gap-2 justify-end">
                                                ...
                                                <Button icon="pi pi-times text-sm leading-none"
                                                    @click="onRemoveTemplatingFile(file, removeFileCallback, index)"
                                                    class="!text-sm !leading-none" label="Cancel" text
                                                    severity="danger" />
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div>
                        ...
                        <div class="mt-4 flex flex-col gap-4">
                            <div class="flex items-center gap-2 justify-between">
                                ...
                                <Select v-model="memberSelectedTypes[0]" :options="memberTypes" optionLabel="name"
                            ...
                            <div class="flex items-center gap-2 justify-between">
                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="text-sm text-muted-color leading-5 line-clamp-4">di.russ23@primevue.org
                                    </div>
                                </div>
                                <Select v-model="memberSelectedTypes[1]" :options="memberTypes" optionLabel="name"
                                    placeholder="Select a role" class="w-16" :pt="{
                                        root: { class: 'border-0 shadow-none' },
                                        label: { class: 'p-0 text-muted-color text-sm' },
                                        dropdown: { class: 'p-0 w-auto' },
                            ...
                            <div class="flex items-center gap-2 justify-between">
                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="text-sm text-muted-color leading-5 line-clamp-4">jac.jon87@primevue.org
                                    </div>
                                </div>
                                <Select v-model="memberSelectedTypes[2]" :options="memberTypes" optionLabel="name"
                                    placeholder="Select a role" class="w-16" :pt="{
                                        root: { class: 'border-0 shadow-none' },
                                        label: { class: 'p-0 text-muted-color text-sm' },
                                        dropdown: { class: 'p-0 w-auto' },
            ...
            <div class="flex-1 flex flex-wrap gap-6">
                <div class="flex-1 border border-surface rounded-3xl p-6">
                    ...
                    <SelectButton v-model="userProfiles" :options="userProfilesOptions" :pt="{
                        root: {
                            class: 'w-full'
                        },
                        pcbutton: {
                ...
                <div class="flex-1 border border-surface rounded-3xl p-6 flex flex-col gap-6">
                    ...
                    <div class="flex items-center justify-center">
                        <InputOtp v-model="forgotPasswordOTP" :length="6" integerOnly :pt="{
                            root: {
                ...
                <div class="border border-surface rounded-3xl p-6">
                    ...
                    <div class="mt-4 flex gap-2">
                        <div class="flex-1">
                            ...
                            <InputNumber v-model="priceRange[0]" :min="0" inputId="price-min-val" mode="currency"
                                currency="USD" locale="en-US" :pt="{
                                    root: {
                                        class: '[&>*]:w-full mt-2'
                                    }
                                }" />
                        ...
                        <div class="flex-1">
                            ...
                            <InputNumber v-model="priceRange[1]" inputId="price-max-val" mode="currency" currency="USD"
                                locale="en-US" :pt="{
                                    root: {
                                        class: '[&>*]:w-full mt-2'
                                    }
