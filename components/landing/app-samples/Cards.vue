        ...
        <div class="mt-6 flex items-start gap-6">
            <div class="flex-1 flex flex-col gap-6">
                <div class="border border-surface rounded-3xl p-6 flex flex-col gap-6">
                    <div class="flex items-center gap-3">
                        <OverlayBadge severity="danger" class="w-fit">
                            <Avatar image="/demo/images/main-avatar.png" size="large" class="rounded-lg overflow-hidden flex" />
                        </OverlayBadge>
                        <div>
                    ...
                    <div class="flex flex-col gap-4">
                        <div class="p-2 rounded-2xl flex items-center gap-3 bg-emphasis">
                            <OverlayBadge severity="danger" class="w-fit">
                                <Avatar image="/demo/images/main-avatar.png" class="rounded-lg overflow-hidden w-10 h-10 block" />
                            </OverlayBadge>
                            <div class="flex-1">
                        ...
                        <div class="p-2 rounded-2xl flex items-center gap-3 bg-emphasis">
                            <OverlayBadge severity="danger" class="w-fit">
                                <Avatar image="/demo/images/avatar9.jpg" class="rounded-lg overflow-hidden w-10 h-10 flex" />
                            </OverlayBadge>
                            <div class="flex-1">
                ...
                <div class="border border-surface rounded-3xl p-6">
                    ...
                    <Divider />
                    <button @click="darkMode = !darkMode" class="w-full flex items-center gap-2 text-color p-2 bg-transparent hover:bg-emphasis active:bg-surface-200 dark:active:bg-surface-700 cursor-pointer rounded-lg transition-all select-none">
                        <i
                        ...
                        <InputSwitch v-model="darkMode" class="pointer-events-none" />
                    </button>
                </div>
                        ...
                        >
                            <template #header="{ chooseCallback, uploadCallback, clearCallback, files, uploadedFiles }">
                                ...
                                <div v-if="files.length <= 0 && uploadedFiles.length <= 0" class="flex flex-col items-center justify-center p-6 cursor-pointer" @click="chooseCallback()">
                                    ...
                                    <div class="text-sm text-color font-medium mt-2">Click to upload <snap class="text-muted-color">or and drop</snap></div>
